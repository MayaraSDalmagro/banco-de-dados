...
SELECT * FROM Filme 
WHERE classificacao = '12' AND duracao_min <= 120;

SELECT titulo FROM Filme 
WHERE genero = 'Terror' OR genero = 'Policial';

SELECT * FROM Filme 
WHERE genero = 'Ficção Científica' AND duracao_min > 150 AND classificacao = '12';
